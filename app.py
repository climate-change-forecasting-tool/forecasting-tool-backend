    ...
    return jsonify(
        {
            ...
            'landslide_probability': (2.0/21.0), 
            'flood_probability': (3.0/21.0), 
            'dry_mass_movement_probability': (4.0/21.0), 
            'extreme_temperature_probability': (5.0/21.0), 
            'storm_probability': (6.0/21.0), 
            'drought_probability': (7.0/21.0), 
            'num_deaths': 31, 
            'num_injured': 32, 
            'damage_cost': 33000
        }
